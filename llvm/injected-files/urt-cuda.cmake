# Copyright (C) 2022 Intel Corporation Part of the Unified-Runtime Project,
...
if(UMF_ENABLE_POOL_TRACKING)
  ...
  message(
    WARNING
      "CUDA adapter USM pools are disabled, set UMF_ENABLE_POOL_TRACKING to enable them"
  )
endif()
...
if(UR_ENABLE_TRACING)
  ...
  target_compile_definitions(${TARGET_NAME} PRIVATE XPTI_ENABLE_INSTRUMENTATION
                                                    XPTI_STATIC_LIBRARY)
  target_include_directories(
    ${TARGET_NAME} PRIVATE ${XPTI_INCLUDES} ${CUDAToolkit_CUPTI_INCLUDE_DIR})
  target_sources(${TARGET_NAME} PRIVATE ${XPTI_PROXY_SRC})
endif()

if(CUDAToolkit_cupti_LIBRARY)
  target_compile_definitions(
    "ur_adapter_cuda" PRIVATE CUPTI_LIB_PATH="${CUDAToolkit_cupti_LIBRARY}")
  list(APPEND EXTRA_LIBS ${CUDAToolkit_cupti_LIBRARY})
endif()

target_link_libraries(
  ${TARGET_NAME}
  PRIVATE ${PROJECT_NAME}::headers ${PROJECT_NAME}::common ${PROJECT_NAME}::umf
          Threads::Threads CUDA::cuda_driver ${EXTRA_LIBS})
